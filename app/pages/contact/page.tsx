...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-black text-white relative z-10">
        <div className="max-w-7xl mx-auto text-center pt-32 lg:pt-44 pb-20">
          <div
