    ...
    <>
        ...
        <h1 className="text-white text-4xl font-bold z-10 py-4 col-span-full mx-auto mb-5 border-b">Photography</h1>
                <div>
                    ...
                    <Button variant="contained" className="mt-4 mb-4 bg-blue text-white hover:bg-light-blue border" href={"https://www.flickr.com/photos/152106905@N06"} target={"_blank"}>Visit Flickr</Button>
                </div>
