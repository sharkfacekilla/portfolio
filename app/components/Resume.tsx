...
const { highlights, education, work, future_projects, extracurricular, technical_skills } = resume.resume;
        ...
        <section className="relative py-12">
            ...
            <div className="container mx-auto flex flex-wrap">
                ...
                <div className="w-full lg:w-3/4 px-4">
                    <h2 className="mx-auto mb-14 font-extrabold tracking-light text-4xl text-shadow lg:text-left text-center px-4">Highlights</h2>
                    ...
                    {Object.values(technical_skills).map((tech_skill, index) => (
                        <li key={index}>
                            <span className="bg-light-blue text-black rounded-full px-4 py-2">{tech_skill}</span>
                        </li>
                    ))}
                    </ul>
                    <hr className="my-12 h-0.5 border-t-0 bg-black dark:bg-blue/50" />
                    ...
                    {Object.keys(work).map((key) => {
                        ...
                        return (
                            <ul className="list-disc list-inside space-y-2 mt-12 px-4" key={key}>
