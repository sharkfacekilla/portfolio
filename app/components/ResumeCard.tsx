...
const ResumeCard: React.FC = () => {
    return (
        <div className="max-w-sm p-6 bg-black rounded-lg shadow sticky top-12">
            ...
            <p className="mb-3 font-normal text-black dark:text-white">Download my resume as a PDF here.</p>
            <a href="../gage-patenaude-resume.pdf" download="gage-patenaude-resume.pdf" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Download
